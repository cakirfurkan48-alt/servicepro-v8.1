...
import { Service, Personnel, ServisPuani, YetkiliDegerlendirmesiUsta, YetkiliDegerlendirmesiCirak, IsmailDegerlendirmesi, AylikPerformans, ServisDurumu, IsTuru } from '@/types';
